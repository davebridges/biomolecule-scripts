Analysis of IKBKE ASO RNAseq Study by DEXSeq
============================================
...
conds <- as.factor(c('Ctl','Ctl','Ctl','Ctl','Ctl','IKK','IKK','IKK','IKK','IKK'))
...
save(dexseq.cds, file="DEXseq_cds.Robject")
table(results$padjust < 0.05)
write.csv(results, file='DEXresults.csv')
library("hwriter")
DEXSeqHTML(cds, FDR = 0.05, color = c("#FF000080", "#0000FF80"))
```
